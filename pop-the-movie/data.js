...
window.POP_DATA = {
  ...
  detail: {
    ...
    score: 0.92,
    synopsis: "In 2087, two memory cartographers fall in love while reconstructing a stranger's final hours. As the line between her recollections and theirs begins to blur, they must decide whose story is worth saving — and whose is worth losing forever.",
    cast: [
    ...
    breakdown: [
      { name: "Acting", icon: "🎭", score: 9.4, note: "Park's quietly devastating turn anchors a film that lives or dies by its leads." },
      { name: "Story", icon: "📖", score: 8.8, note: "Tanaka's screenplay folds in on itself with the precision of origami — and the patience of a long letter." },
      { name: "Visuals", icon: "🎨", score: 9.7, note: "Cinematographer K. Lin paints in soft neons. Every frame feels like a memory you're trying to hold." },
      { name: "Sound", icon: "🎵", score: 9.1, note: "A hushed, synth-laced score from Yuki Mori does most of the emotional heavy lifting." },
    ],
  },
  comments: [
